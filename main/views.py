...
from .serializers import  CategorySerializer, PostSerializer, CommentSerializer, RatingSerializer, \
    LikeSerializer, FavouriteSerializer, HistorySerializer
...
class PostViewSet(PermissionMixin, viewsets.ModelViewSet):
    ...
    def favourite(self, request, pk=None):
        ...
        if not created:
            ...
            obj.save()
        favourites = 'added to favorites' if obj.favourite else 'removed from favorites'
